...
class StatistikaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Statistika'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->statistika_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Statistika');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='statistika-form')
		{
